...
tf.app.flags.DEFINE_float('train_learning_rate', 0.001, 'Initial learning rate.')
tf.app.flags.DEFINE_float('train_learning_rate_decay_factor', 0.94, 'Learning rate decay factor.')
tf.app.flags.DEFINE_string('train_checkpoint_model_scope', 'MobilenetV1',
    'Model scope in the checkpoint. None if the same as the trained model.')
...
tf.app.flags.DEFINE_string('train_checkpoint_exclude_scopes',
                           'MobilenetV1/Conv2d_6_pointwise,'
                           'mobilenet_v1_1.0_224/Conv2d_7_pointwise,'
                           'mobilenet_v1_1.0_224/Conv2d_8_pointwise,'
                           'mobilenet_v1_1.0_224/Conv2d_9_pointwise,'
                           'mobilenet_v1_1.0_224/Conv2d_10_pointwise,'
                           'mobilenet_v1_1.0_224/Conv2d_11_pointwise,'
                           'mobilenet_v1_1.0_224/Conv2d_4_pointwise_box,'
                           'mobilenet_v1_1.0_224/Conv2d_7_pointwise_box,'
                           'mobilenet_v1_1.0_224/Conv2d_8_pointwise_box,'
                           'mobilenet_v1_1.0_224/Conv2d_9_pointwise_box,'
                           'mobilenet_v1_1.0_224/Conv2d_10_pointwise_box,'
                           'mobilenet_v1_1.0_224/Conv2d_11_pointwise_box',
                           'list of variables to exclude when restoring from a checkpoint.')
'''
tf.app.flags.DEFINE_string('train_trainable_scopes',
                           ...
                           'MobilenetV1/Conv2d_10_pointwise,'
                           'MobilenetV1/Conv2d_11_pointwise,'
                           #'MobilenetV1/Conv2d_7_pointwise_box,'
                           #'MobilenetV1/Conv2d_8_pointwise_box,'
                           #'MobilenetV1/Conv2d_9_pointwise_box,'
                           #'MobilenetV1/Conv2d_10_pointwise_box,'
                           'Conv2d_11_pointwise_box',
    'list of scopes to filter the set of variables to train.By default, None would train all the variables.')
'''
tf.app.flags.DEFINE_string('train_trainable_scopes',
                           'mobilenet_v1_1.0_224/Conv2d_6_pointwise,'
                           'mobilenet_v1_1.0_224/Conv2d_7_pointwise,'
                           'mobilenet_v1_1.0_224/Conv2d_8_pointwise,'
                           'mobilenet_v1_1.0_224/Conv2d_9_pointwise,'
                           'mobilenet_v1_1.0_224/Conv2d_10_pointwise,'
